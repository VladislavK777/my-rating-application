...
@Entity
@Table(name = "cat_additional")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CatAdditional implements CatalogForSoftDelete {
    @Id
    @Column(name = "id")
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatAdditional)) {
            return false;
        }
        return id != null && id.equals(((CatAdditional) o).id);
    }
